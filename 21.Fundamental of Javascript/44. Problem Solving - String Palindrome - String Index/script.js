...
function checkPalindrome(inputNumber) {
  ...
  //* Looping Variable
  let i = 0; // variable i
  let j = string.length - 1; // variable j
  ...
  return true;
  //* If there was not mismatch in palindrome than return the true
}


//? Lets check the palindrome implementation by calling function 
console.log(checkPalindrome(1991)); //* Output : true 
console.log(checkPalindrome(19891)); //* Output : true 
console.log(checkPalindrome(10000)); //* Output : false 
console.log(checkPalindrome(8998)); //* Output : true 
console.log(checkPalindrome(2)); //* Output : true 